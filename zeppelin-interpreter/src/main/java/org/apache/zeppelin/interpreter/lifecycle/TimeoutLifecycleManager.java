...
import org.apache.zeppelin.bde.spark.SparkTimeOutRunnable;
...
public class TimeoutLifecycleManager extends LifecycleManager {
  ...
  private Long lastSparkOverTime;
  ...
  public void onInterpreterUse(String interpreterGroupId) {
    ...
    if (lastSparkOverTime == null || (lastBusyTimeInMillis - lastSparkOverTime) > 10000L) {
      lastSparkOverTime = lastBusyTimeInMillis;
      Thread sparkTimeoutRunner = new Thread(new SparkTimeOutRunnable(interpreterGroupId,lastBusyTimeInMillis));
      sparkTimeoutRunner.start();
    }
