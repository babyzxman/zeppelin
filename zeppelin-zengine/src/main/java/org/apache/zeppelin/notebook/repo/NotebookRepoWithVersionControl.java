...
public interface NotebookRepoWithVersionControl extends NotebookRepo {
   ...
   */
  class Revision {
    public static final Revision EMPTY = new Revision(StringUtils.EMPTY, StringUtils.EMPTY, 0, false);
    ...
    public Revision(String revId, String message, int time, boolean isConflicts) {
      this.id = revId;
      this.message = message;
      this.time = time;
      this.isConflicts = isConflicts;
    }
