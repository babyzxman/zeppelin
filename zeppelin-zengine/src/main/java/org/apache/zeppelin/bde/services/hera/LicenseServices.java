...
import org.apache.zeppelin.bde.services.hera.view.HealthStatusRequest;
...
public class LicenseServices {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(LicenseServices.class);
    ...
    public void sendSparkJobHealthStatus(String jobId, Date startTime, Date currentTime, Date previousTime, boolean isLastTime) throws Exception{
        ...
        String url = zConf.getString(ZeppelinConfiguration.ConfVars.ZEPPELIN_APP_PREFIX_URL)+"://"+ addr
                ...
                +zConf.getString(ZeppelinConfiguration.ConfVars.ZEPPELIN_SERVER_SEND_HEALTH_STATUS_URL);
    ...
    public void callValidateLicenseAndHoldCpu(String jobId) throws Exception{
        ...
        String tmpUri = zConf.getString(ZeppelinConfiguration.ConfVars.ZEPPELIN_APP_PREFIX_URL)+"://"+ addr
                +":"+(zConf.getBoolean(ZeppelinConfiguration.ConfVars.ZEPPELIN_SSL) ? zConf.getString(ZeppelinConfiguration.ConfVars.ZEPPELIN_SSL_PORT) : port)
                +zConf.getString(ZeppelinConfiguration.ConfVars.ZEPPELIN_SERVER_LICENSE_VALIDATE_HOLD_CPU_URL);
    ...
    public void callValidateLicenseCpu() throws Exception{
        ...
        String url = zConf.getString(ZeppelinConfiguration.ConfVars.ZEPPELIN_APP_PREFIX_URL)+"://"+ addr
                +":"+(zConf.getBoolean(ZeppelinConfiguration.ConfVars.ZEPPELIN_SSL) ? zConf.getString(ZeppelinConfiguration.ConfVars.ZEPPELIN_SSL_PORT) : port)
                +zConf.getString(ZeppelinConfiguration.ConfVars.ZEPPELIN_SERVER_LICENSE_VALIDATE_CPU_URL);
    ...
    public void callReleaseCpu(String jobId) throws Exception{
        ...
        String tmpUri = zConf.getString(ZeppelinConfiguration.ConfVars.ZEPPELIN_APP_PREFIX_URL)+"://"+ addr
                +":"+(zConf.getBoolean(ZeppelinConfiguration.ConfVars.ZEPPELIN_SSL) ? zConf.getString(ZeppelinConfiguration.ConfVars.ZEPPELIN_SSL_PORT) : port)
                +zConf.getString(ZeppelinConfiguration.ConfVars.ZEPPELIN_SERVER_LICENSE_RELEASE_CPU_URL);
        String restUri = UriComponentsBuilder.fromUriString(tmpUri).buildAndExpand(jobId).toUriString();
