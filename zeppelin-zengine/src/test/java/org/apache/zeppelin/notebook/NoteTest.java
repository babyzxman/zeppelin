...
class NoteTest {
  ...
  void runNormalTest() throws InterpreterNotFoundException {
    ...
    Note note = new Note("test", "test", interpreterFactory, interpreterSettingManager, paragraphJobListener, credentials, noteEventListener,null);
  ...
  void addParagraphWithEmptyReplNameTest() {
    Note note = new Note("test", "", interpreterFactory, interpreterSettingManager, paragraphJobListener, credentials, noteEventListener,null);
    Paragraph p = note.addNewParagraph(AuthenticationInfo.ANONYMOUS);
