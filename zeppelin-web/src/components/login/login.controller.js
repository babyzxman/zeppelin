...
function LoginCtrl($scope, $rootScope, $http, $httpParamSerializer, baseUrlSrv, $location, $timeout, $window) {
  'ngInject';
  ...
  $scope.login = function() {
    ...
    $http({
      ...
      $window.localStorage.setItem('user', $scope.loginParams.userName);
      $scope.SigningIn = false;
