...
function overrideBootstrapDialog() {
  /**
    * Confirm window
    *
    * @param {type} message
    ...
    * @returns {undefined}
    */
  BootstrapDialog.confirm = function(option) {
    let dialog = new BootstrapDialog({
      ...
      buttons: [{
        ...
        label: option.confirmButtonText || 'OK',
  ...
  * @returns {undefined}
  */
  BootstrapDialog.showEx = function(option) {
    let dialog = new BootstrapDialog({
      title: option.title,
      message: option.message,
      closable: false,
  ...
  BootstrapDialog.expired = function(option) {
    let dialog = new BootstrapDialog({
      title: option.title,
      message: option.message,
      closable: false,
