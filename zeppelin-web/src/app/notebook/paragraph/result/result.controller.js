  ...
  $scope.builtInTableDataVisualizationList = [
    {
      ...
      icon: '<img class="icon-chart" src="assets/images/icon_chart/table.svg"/>',
      supports: [DefaultDisplayType.TABLE, DefaultDisplayType.NETWORK],
    },
    {
      id: 'multiBarChart',
      name: 'Bar Chart',
      icon: '<img class="icon-chart" src="assets/images/icon_chart/bar.svg"/>',
    ...
    },
    {
      id: 'pieChart',
      name: 'Pie Chart',
      icon: '<img class="icon-chart" src="assets/images/icon_chart/pie.svg"/>',
      transformation: 'pivot',
      supports: [DefaultDisplayType.TABLE, DefaultDisplayType.NETWORK],
    },
    {
      id: 'stackedAreaChart',
      name: 'Area Chart',
      icon: '<img class="icon-chart" src="assets/images/icon_chart/area.svg"/>',
      transformation: 'pivot',
      supports: [DefaultDisplayType.TABLE, DefaultDisplayType.NETWORK],
    },
    {
      id: 'lineChart',
      name: 'Line Chart',
      icon: '<img class="icon-chart" src="assets/images/icon_chart/line.svg"/>',
      transformation: 'pivot',
      supports: [DefaultDisplayType.TABLE, DefaultDisplayType.NETWORK],
    },
    {
      id: 'scatterChart',
      name: 'Scatter Chart',
      icon: '<img class="icon-chart" src="assets/images/icon_chart/scatter.svg"/>',
      supports: [DefaultDisplayType.TABLE, DefaultDisplayType.NETWORK],
    },
    {
      id: 'network',
      name: 'Network',
      icon: '<img class="icon-chart" src="assets/images/icon_chart/network.svg"/>',
