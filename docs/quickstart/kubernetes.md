...
# Looking at the "./pom.xml" we can see the version is 4.6.8
...
docker build -t zeppelin-server:4.6.8 -f ./Dockerfile .
```
...
docker build -t zeppelin-interpreter:4.6.8 -f ./Dockerfile .
```
...
zeppelin-interpreter          4.6.8            4f77fe989eed   3 minutes ago    622MB
zeppelin-server               4.6.8            4f77fe989eed   3 minutes ago    622MB
