...
```bash
docker run -p 8080:8080 --rm --name zeppelin apache/zeppelin:4.6.8
...
docker run -u $(id -u) -p 8080:8080 --rm -v $PWD/logs:/logs -v $PWD/notebook:/notebook \
           ...
           --name zeppelin apache/zeppelin:4.6.8
```
...
-e SPARK_HOME=/opt/spark  -e ZEPPELIN_NOTEBOOK_DIR='/notebook' --name zeppelin apache/zeppelin:4.6.8
```
